...
//#define BMA253_RANGE 						BMA2x2_RANGE_8G
#define BMA253_BANDWIDTH 				BMA2x2_BW_7_81HZ
#define BMA253_RANGE 						BMA2x2_RANGE_2G
//#define BMA253_BANDWIDTH 				BMA2x2_BW_7_81HZ
...
#define BMA253_STAT_FLAT_ORIENT_HIGH_REG   	0x0C
#define BMA2x2_RANGE_SELECT_REG                 0x0F
#define BMA2x2_BW_SELECT_REG                    0x10
#define BMA253_PMU_LPW_REG                     0x11
#define BMA253_PMU_LOW_POWER_REG               0x12
...
#define BMA253_OFC_SETTING_REG                 0x37
...
#define BMA253_10_BIT_SIGN_SHIFT       9
#define BMA253_10_BIT_MASK        0x3ff
#define BMA253_10_NEW_DATA_MASK        0x01
#define BMA253_10_BIT_DATA_SHIFT       6
...
/***************************************************/
#define BMA253_MODE_MASK           0x1f
#define BMA253_MODE_Normal         0x00
#define BMA253_MODE_DeepSuspend    0x20
#define BMA253_MODE_LowPower       0x40
#define BMA253_MODE_Suspend        0x80

#define BMA253_SLEEP_DURING_MASK   0xe0
#define BMA253_SLEEP_DURING_0_5ms  0x00
#define BMA253_SLEEP_DURING_1ms    0x0c
#define BMA253_SLEEP_DURING_2ms    0x0e
#define BMA253_SLEEP_DURING_4ms    0x10
#define BMA253_SLEEP_DURING_6ms    0x12
#define BMA253_SLEEP_DURING_10ms   0x14
#define BMA253_SLEEP_DURING_25ms   0x16
#define BMA253_SLEEP_DURING_50ms   0x18
#define BMA253_SLEEP_DURING_100ms  0x1a
#define BMA253_SLEEP_DURING_500ms  0x1c
#define BMA253_SLEEP_DURING_1s     0x1e

/****************************************************/
/**\name  LOW POWER MODE SELECT AND SLEEP TIMER MODE*/
/***************************************************/
#define BMA253_LOW_POWER_MODE_MASK           0xBf
#define BMA253_LOW_POWER_MODE_BIT              6
#define BMA253_LOW_POWER_SLEEP_TIMER_MODE_MASK 0xDf
#define BMA253_LOW_POWER_SLEEP_TIMER_MODE_BIT  5

/****************************************************/
/**\name INTERRUPT STATUS FLAT ORIENT HIGH*/
/***************************************************/
#define BMA253_INT_STATUS_FLAT_MASK           0x80

/****************************************************/
/**\name OFFSET COMPENSATION SETTING                */
/***************************************************/
#define BMA253_FFSET_COMPENSATION_MASK           0x81
#define BMA253_FFSET_COMPENSATION_Z_BIT            5
#define BMA253_FFSET_COMPENSATION_Y_BIT            3
#define BMA253_FFSET_COMPENSATION_X_BIT            1
#define BMA253_FFSET_COMPENSATION_CAL_RTY_SHIFT    4
#define BMA253_FFSET_COMPENSATION_CAL_TRIGGER_SHIFT    5
#define BMA253_FFSET_COMPENSATION_CAL_TRIGGER_MASK 0x9F

struct BMA253_Accel_Data{
	int8_t new_data_x;
	int16_t x_lsb;
	int8_t new_data_y;	
	int16_t y_lsb;
...
struct BMA253_Compensation_Data{
	int8_t x_offset;
	int8_t y_offset;	
	int8_t z_offset;		
};

typedef void( BMA253IrqHandler )(void );
